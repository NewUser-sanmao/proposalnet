package com.bootdo.proposal.excel;
...
public class ExcelUtil  {
     ...
     * @return
     */
    public static List<Map<String ,Object>> getAllByExcel(File file){
        ...
        try {
            ...
            for (int i = 1; i < rows; i++) {
                ...
                for (int j = 0; j < clos; j++) {
                    ...
                    m.put(rs.getCell(j, 0).getContents().toString(),rs.getCell(j, i).getContents());
