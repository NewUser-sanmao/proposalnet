        ...
        .bootstrapTable(
            {
                ...
                url : prefix + "/tacbdwhzList", // 服务器数据的加载地址
                cache : false,
                //	showRefresh : true,
                //	showToggle : true,
                //	showColumns : true,
...
function dc(){
    ...
    layer.confirm('确认要导出吗？', {
        ...
        //确认
        var action = "/proposal/tjfx/tacbdwhzDownLoad";
        var form = $("<form></form>");
...
function dcCbtaml(){
	...
	// 按钮
        ...
        var action = "/proposal/tjfx/exportCbtaml";
        var form = $("<form></form>");
        form.attr('action', action);
        form.attr('method', 'post');
        form.attr('target', '_blank');
        ...
        var input2 = $("<input type='hidden' name='cbdwIds' />");
